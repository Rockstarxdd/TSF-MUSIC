            ...
            [ 
                [
                    InlineKeyboardButton(
                        "➕ Group me daal de bc ➕", url=f"http://t.me/DJ_ALOK_VC_BOT?startgroup=true")
                ],[
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "💝 Mera maalik ", url=f"https://t.me/{OWNER_NAME}")
                ],[
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "👨‍💻 Developer", url="https://t.me/t5f_r0ck5t4r")
                ],[
                    InlineKeyboardButton(
                        "🧪 Source Code 🧪", url="https://github.com/T5FR0CK5T4R"
                    )
                ]
            ]
        ),

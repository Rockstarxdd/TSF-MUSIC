...
async def pause(_, message: Message):
    ...
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        ...
        await message.reply_text("❗ kya pause kru jab play hi nhi hai 🙄!")
    else:
        callsmusic.pytgcalls.pause_stream(chat_id)
        await message.reply_text("▶️ le stop krdiya!")
...
async def resume(_, message: Message):
    ...
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        ...
        await message.reply_text("❗ resume krne ke liye kuch hai hi nhi 🥲!")
    else:
        callsmusic.pytgcalls.resume_stream(chat_id)
        await message.reply_text("⏸ Le chala diya !")
...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❗ play krne ko kuch hai hi nhi 🥲!")
    else:
        try:
        ...
        await message.reply_text("⏹ khatam!")
...
async def skip(_, message: Message):
    ...
    chat_id = get_chat_id(message.chat)
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❗ kuch chal hi nhi rha 🥲!")
    else:
...
async def cbpause(_, query: CallbackQuery):
    ...
    if (
        ...
        await query.edit_message_text("❗️ play krne ko kuch hai hi nhi ", reply_markup=BACK_BUTTON)
    else:
        callsmusic.pytgcalls.pause_stream(query.message.chat.id)
        await query.edit_message_text("▶️ music rok diya ", reply_markup=BACK_BUTTON)
...
async def cbresume(_, query: CallbackQuery):
    ...
    if (
        ...
        await query.edit_message_text("⏸ music chala diya ", reply_markup=BACK_BUTTON)
...
async def cbend(_, query: CallbackQuery):
    ...
    if query.message.chat.id not in callsmusic.pytgcalls.active_calls:
        await query.edit_message_text("❗️ kuch play hi nhi hai 🙄", reply_markup=BACK_BUTTON)
    else:
        try:
